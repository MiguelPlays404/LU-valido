  ...
  return (
    <footer className="bg-surface-dark-soft pt-16 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/levillepetbauru/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary hover:bg-primary/20 transition-colors" aria-label="Instagram">
              ...
              <a href="https://wa.me/5514997145610" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-whatsapp/10 flex items-center justify-center text-whatsapp hover:bg-whatsapp/20 transition-colors" aria-label="WhatsApp">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              {footerLinks.map((link) => (
                <Link key={link.path} to={link.path} className="text-text-on-dark-muted text-sm hover:text-primary transition-colors">
                  {link.label}
                </Link>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm mb-6">
              <a href="https://wa.me/5514997145610" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-text-on-dark-muted hover:text-primary transition-colors">
        ...
        {/* Bottom */}
        <div className="border-t border-text-on-dark/10 pt-6 text-center">
