    ...
    <footer style={{ background: '#111111' }} className="pt-16 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          {/* Col 1 - Logo & About */}
          <div>
            <div className="h-11 px-3 py-1 bg-primary rounded-lg inline-flex items-center mb-3">
              <span className="font-heading font-extrabold text-black text-lg">Le Ville Pet</span>
            </div>
            <p className="font-heading italic text-primary text-[15px] mb-3">"a gente se entende"</p>
            <p className="text-[#888] text-sm leading-relaxed mb-4" style={{ fontFamily: 'Inter' }}>
              Cuidamos do seu pet com amor em Bauru-SP.
            </p>
            <div className="flex gap-3">
              <a href="https://www.instagram.com/levillepetbauru/" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://wa.me/5514997145610" target="_blank" rel="noopener noreferrer"
          ...
          {/* Col 2 - Navigation */}
          <div>
            <h3 className="font-heading font-semibold text-white text-sm mb-4">Navegação</h3>
            <div className="flex flex-col gap-2">
              {footerLinks.map((link) => (
                <Link key={link.path} to={link.path} className="text-[#888] text-sm hover:text-primary transition-colors" style={{ fontFamily: 'Inter' }}>
                  {link.label}
                </Link>
              ))}
            </div>
          ...
          {/* Col 3 - Contact */}
          <div>
            <h3 className="font-heading font-semibold text-white text-sm mb-4">Contato</h3>
            <div className="flex flex-col gap-3 text-sm mb-6" style={{ fontFamily: 'Inter' }}>
              <a href="https://wa.me/5514997145610" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 text-[#888] hover:text-primary transition-colors">
                <Phone className="w-4 h-4 text-primary" />
                (14) 99714-5610
              </a>
              <a href="https://maps.app.goo.gl/nkuDnVyBe6ZHYNbS8" target="_blank" rel="noopener noreferrer"
                className="flex items-start gap-2 text-[#888] hover:text-primary transition-colors">
        ...
        {/* Bottom - separator with animation + admin field */}
