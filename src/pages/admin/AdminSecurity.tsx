    ...
    <AdminLayout title="Segurança">
      <div className="max-w-lg space-y-8">
        ...
        <div className="bg-[#1A1A1A] rounded-xl p-5 border border-[#222]">
          ...
          <p className="text-[#888] text-sm mb-4">Você está conectado há {sessionText}.</p>
        ...
        <div className="bg-[#1A1A1A] rounded-xl p-5 border border-[#222]">
          ...
          <div className="space-y-4">
            <div>
              <label className="text-xs text-[#666] mb-1 block">Código atual</label>
            ...
            <div>
              <label className="text-xs text-[#666] mb-1 block">Novo código</label>
              <input type="password" value={newCode} onChange={e => { setNewCode(e.target.value); setError(""); }}
                className="w-full bg-[#111] border border-[#333] rounded-lg px-3 py-2 text-sm text-white" />
            </div>
            <div>
              <label className="text-xs text-[#666] mb-1 block">Confirmar novo código</label>
