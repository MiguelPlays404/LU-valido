...
export default function AdminConhecer() {
  ...
  const handleSave = async () => {
    ...
    if (config?.id) await supabase.from("site_config").update({ conhecer_hero_image_url: config.conhecer_hero_image_url, conhecer_about_title: config.conhecer_about_title, conhecer_gallery_title: config.conhecer_gallery_title, conhecer_cta_title: config.conhecer_cta_title, conhecer_cta_btn_text: config.conhecer_cta_btn_text }).eq("id", config.id);
